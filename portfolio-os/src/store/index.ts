...
export const useWindows = () => useWindowStore(useShallow((state) => {
...
export const useTheme = () => useThemeStore(useShallow((state) => ({
...
export const useNotifications = () => useNotificationStore(useShallow((state) => ({
...
export const useApps = () => useAppStore(useShallow((state) => ({
...
export const useOSStatus = () => useOSStore(useShallow((state) => ({
