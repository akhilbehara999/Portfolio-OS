    ...
    >
       ...
       <div className="flex justify-between items-start z-10">
         <div className="flex flex-col">
           <span className="text-4xl md:text-5xl font-light text-slate-800 dark:text-white tracking-tighter">{temp}°</span>
           <span className="text-sm md:text-base text-slate-600 dark:text-slate-300 font-medium mt-1">{condition}</span>
         </div>
